...
const SERVICES = [
  {
    ...
    desc: "Arquitecturas Next.js optimizadas para una velocidad de carga instantánea y SEO de alto impacto.",
    href: "/servicios/desarrollo-web-alto-impacto",
  ...
  },
  {
    ...
    desc: "Sistemas inteligentes que automatizan la atención al cliente y cierran ventas de forma autónoma.",
    href: "/servicios/agentes-ia",
    icon: <Cpu className="text-[#D62828]" size={32} />,
    tags: ["LLMs", "RAG", "Atención 24/7"]
  },
  {
    id: "03",
    title: "Automatización Operativa",
    desc: "Eliminamos las tareas repetitivas conectando todo tu ecosistema digital con n8n.",
    href: "/servicios/automatizacion-n8n",
    icon: <Zap className="text-[#D62828]" size={32} />,
    tags: ["n8n", "Webhooks", "CRMs"]
  },
  {
    id: "04",
    title: "Soluciones a Medida",
    desc: "Software específico diseñado para resolver los desafíos únicos de tu operación de negocio.",
  ...
  return (
    <main className="min-h-screen w-full bg-[#080808] text-white pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <p className="font-mono text-[#D62828] text-xs tracking-[0.3em] uppercase mb-6">/ Capacidades Zenit</p>
          <h1 className="font-display text-5xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-8">
          ...
          <p className="text-white/50 text-lg md:text-xl font-light leading-relaxed">
            No somos generalistas. Nos especializamos en tecnologías que multiplican la eficiencia y la visibilidad de tu negocio a través de la ingeniería de precisión.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-40">
          {SERVICES.map((service, i) => (
            ...
            >
              <Link 
                href={service.href}
                className="group block p-12 bg-[#111] border border-white/5 rounded-[2.5rem] hover:border-[#D62828]/40 transition-all relative overflow-hidden h-full shadow-2xl"
              >
                <div className="absolute top-0 right-0 p-8 text-white/5 group-hover:text-[#D62828]/10 transition-colors pointer-events-none">
                   <span className="font-display text-9xl font-black">{service.id}</span>
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-display text-3xl font-bold mb-4 group-hover:text-white transition-colors">{service.title}</h3>
                  <p className="text-white/40 text-sm leading-relaxed mb-8 max-w-sm">{service.desc}</p>
                  
                  <div className="flex flex-wrap gap-2 mb-10">
                    {service.tags.map(tag => (
                      <span key={tag} className="px-3 py-1 bg-white/5 rounded-full font-mono text-[9px] uppercase tracking-widest text-white/40 border border-white/5">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-[3rem] bg-white p-12 md:p-24 overflow-hidden text-center"
        >
           <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
           <div className="relative z-10">
              <h2 className="font-display text-4xl md:text-7xl font-black uppercase text-[#080808] mb-8 leading-none tracking-tighter">
                ¿Listo para el <br /> siguiente nivel?
              </h2>
              <p className="text-[#080808]/60 text-lg mb-12 max-w-xl mx-auto">

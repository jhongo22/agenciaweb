...
import { Zap, Link as LinkIcon, Database, Share2, ShieldCheck, Clock, TrendingUp, ArrowRight, Settings, Smartphone, Mail, CreditCard } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-40">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-[#00CC66]/30 rounded-full mb-8 bg-[#00CC66]/5">
              ...
              <span className="font-mono text-[10px] text-[#00CC66] uppercase tracking-widest">Ecosistemas Hiperconectados</span>
            </div>
            ...
            <div className="flex flex-wrap gap-6">
              <Link href="/start" className="px-8 py-4 bg-[#00CC66] text-[#080808] font-bold text-xs tracking-widest uppercase hover:bg-white transition-all shadow-[0_0_30px_rgba(0,204,102,0.2)]">

      ...
      <div className="relative z-10 pt-28 md:pt-36 pb-24 md:pb-40 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16 md:mb-24">
            ...
            >
              Cada línea de código, cada agente de IA desplegado y cada automatización conectada ha sido diseñada para resolver cuellos de botella y potenciar las ventas de negocios reales.
            </motion.p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-between items-start lg:items-center mb-12 md:mb-16">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Buscar por tecnología, cliente, título..."
                value={searchQuery}
          ...
          {filteredProjects.length === 0 && (
            <div className="text-center py-32">
              <p className="font-display text-4xl text-white/20 mb-4 uppercase tracking-tighter">Sin resultados</p>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="font-sans text-sm md:text-base text-black/50 leading-relaxed mb-10 max-w-lg mx-auto">
                Cada proyecto comienza con una conversación sencilla. Cuéntanos tu problema comercial actual y construyamos un sistema implacable para resolverlo.
              </p>
